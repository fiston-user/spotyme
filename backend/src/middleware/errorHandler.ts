...
const errorMessageMap: Record<string, string> = {
  ...
  'MongoDB connection error': 'Database connection issue. Please try again later.',
  'Failed to exchange authorization code': 'Authorization failed. Please try again.',
  'Failed to refresh access token': 'Session refresh failed. Please login again.',
...
export const errorHandler = (
  ...
  console.error(`[Error ${errorId}] ${status}: ${err.message}`);
